...
const Sidebar = () => (
  <div className="sidebar">
    ...
    <ul>
      ...
      <li><span className="sidebar-icon">📁</span> My Projects</li>
      <li><span className="sidebar-icon">📈</span> Charts</li>
      <li><span className="sidebar-icon">📝</span> Reports</li>
      <li><span className="sidebar-icon">⚙️</span> Settings</li>
    </ul>
  </div>
);
  ...
  return (
    <div className="app-container">
      ...
      <div className="dashboard-container">
        ...
        <p className="dashboard-subtitle">View your recent data analysis and visualizations</p>
        ...
        <div className="card-grid">
          ...
          <Card
            title="Last Analysis"
            value={files.length > 0 ? `File ${files.length}` : 'No analysis yet'}
          />
        </div>
